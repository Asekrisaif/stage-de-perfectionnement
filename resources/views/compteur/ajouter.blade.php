...
<html lang="en">
  ...
  <div class="container ">
    ...
    <form action="/ajouter/compteurs" method="POST" class="form-group">
        @csrf
  <div class="form-group">
  <label for="moyConsommation">Moyenne de consommation</label>
<input type="number" class="form-control" id="moyConsommation" name="moyConsommation" required>

    

    <label for="number" >numSerie</label>
    <input type="number" class="form-control" id="Nom" name="numSerie">
   

    <label for="text" >modele</label>
    <input type="text" class="form-control" id="Nom" name="modele">
   

    <label for="date" >dateInstallation</label>
    <input type="date" class="form-control" id="Nom" name="dateInstallation">
    

    <label for="Nom" >marque</label>
    <input type="text" class="form-control" id="Nom" name="marque">
...
<select name="typecompteur_id" class="form-control">
    ...
    @foreach($typecompteurs as $typecompteur)
