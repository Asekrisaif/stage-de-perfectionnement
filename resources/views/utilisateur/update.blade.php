...
<html lang="en">
  ...
  <div class="container ">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="Email" name="email" value="{{ $utilisateurs->email }}">
    </div>
    <div class="form-group">
        <label for="Password">Password</label>
        <input type="password" class="form-control" id="Password" name="password" value="{{ $utilisateurs->password }}">
    </div>
    <div class="form-group">
        <label for="Role">Role</label>
        <input type="text" class="form-control" id="Role" name="role" value="{{ $utilisateurs->role }}">
    </div>
